...
<template>
  <div class="home-page">
    <ClientHeader v-model="search" @search="() => { filters.search = search; currentPage = 1; fetchMasters() }" />
    ...
    <section class="hero">
      <div class="hero__inner">
        ...
        <div class="hero__search-bar">
          ...
          <input v-model="heroSearch" type="text" placeholder="Masalan: elektrik, santexnik..."
    ...
    <div class="main-content">
      <div class="main-content__inner">
        <FilterSidebar v-model="filters" :mobile-open="mobileFilterOpen" @apply="applyFilters"
        ...
        <div class="masters-section">
          ...
          <div v-if="lastPage > 1" class="pagination">
            ...
            <button v-if="currentPage < lastPage - 2" class="pagination__btn" @click="changePage(lastPage)">{{ lastPage
              }}</button>

...
const {
  ...
  fetchList: (params) => getVacancies(params),
  fetchSecondaryCount: () => getResumes({ limit: 1 }),
  buildParams,
  syncToUrl,
  loadFromUrl,
  ...
  <div class="client-page client-page--vacancies">
    ...
    <div class="client-stats">
      <div class="client-stats__inner">
        <RouterLink to="/" class="client-stats-card client-stats-card--surface">
    ...
    <div class="client-content">
      <div class="client-content__inner">
        ...
        <div class="client-results">
          ...
          <template v-else>
            <div v-if="vacancies.length" class="client-grid">
              <VacancyCard v-for="vacancy in vacancies" :key="vacancy.id" :item="vacancy" />
            </div>

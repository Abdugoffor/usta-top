...
<template>
  <div class="vacancies-page">
    <ClientHeader v-model="search" @search="() => { filters.search = search; currentPage = 1; fetchVacancies() }" />
      ...
      <div class="hero__inner">
        ...
        <div class="hero__search-bar">
          ...
          <input
            ...
            @keydown.enter="doHeroSearch"
          />
          <button @click="doHeroSearch">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/>
            </svg>
            <span>Qidirish</span>
...
.hero__search-bar input::placeholder { color: #9ca3af; }
...
.hero__search-bar button svg { width: 16px; height: 16px; }
.hero__search-bar button:hover { opacity: 0.9; }
...
@media (max-width: 640px) {
  ...
  .hero__search-bar { padding: 5px 5px 5px 14px; }
  .hero__search-bar button span { display: none; }
  .hero__search-bar button { padding: 10px 14px; }

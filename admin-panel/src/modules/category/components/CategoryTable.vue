        ...
        <tr v-for="item in items" :key="item.id" class="ct-row">
          ...
          <td class="ct-td ct-td--actions">
            <div class="ct-actions">
              <button class="ct-btn ct-btn--show"   @click="emit('show', item)"   title="Ko'rish">
...
.ct-skeleton__row { display:grid; grid-template-columns:60px 1fr 120px 100px; gap:16px; padding:14px 16px; border-bottom:1px solid var(--border); align-items:center; }
...
.ct-th--actions { text-align:center; width:120px; }
...
.ct-actions { display:flex; align-items:center; justify-content:center; gap:6px; }
...
.ct-btn--show { background:linear-gradient(135deg,#0ea5e9,#06b6d4); box-shadow:0 2px 8px rgba(14,165,233,.3); }
.ct-btn--show:hover { box-shadow:0 6px 16px rgba(14,165,233,.45); }

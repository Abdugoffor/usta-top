...
const docTemplate = `{
    ...
    "paths": {
        "/categories": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Nomi bo'yicha filter",
                        "name": "name",
                        "in": "query"
                    },
                    {
        ...
        "/comments": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "comment yoki review",
                        "name": "type",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/comment_dto.CreateCommentRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/comment_dto.CommentResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/comment_dto.UpdateCommentRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/region_dto.ListRegionsResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/region_dto.CreateRegionRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/region_dto.RegionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/region_dto.UpdateRegionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/resumes": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Resume ma'lumotlari",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "comment_dto.CreateCommentRequest": {
            "type": "object",
            "required": [
                "text",
                "type"
        ...
        "comment_dto.UpdateCommentRequest": {
            "type": "object",
            "properties": {
                "text": {
                    "type": "string",
        ...
        "region_dto.CreateRegionRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "region_dto.ListRegionsResponse": {
            "type": "object",
            "properties": {
                "limit": {
                    "type": "integer"
        ...
        "region_dto.UpdateRegionRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
